...
@Component
public class CustomerBucketMenu implements Menu{
    private final Map<String, Action> actionMap;

    @Autowired
    public CustomerBucketMenu(Map<String, Action> actionMap) {
    ...
    public int performAction(int actionNumber) {
        switch (actionNumber) {
            ...
            case 2 -> actionMap.get("makeCustomerOrderAction").perform();
